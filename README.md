...
## Author: Macedo, G. Diniz
## Data: 5 de julho de 2024. 

### O Author
![C4](/docs/img/developer-MacedoGDiniz.jpg)

## Descrição:
Este projeto tem o missão de desenvolver na prática como implementar o TDD em uma aplicação utilizando FastAPI juntamente com Pytest. Criaremos juntos uma API utilizando o banco de dados MongoDB e realizando testes unitários e de integração. Além disso, abordaremos boas práticas de como documentar um projeto.

## O que é TDD?
TDD é uma sigla para `Test Driven Development`, ou Desenvolvimento Orientado a Testes. A ideia do TDD é que possamos trabalhar em ciclos.
